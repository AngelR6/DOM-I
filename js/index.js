...
const menuItem1 = navLinks[0];
const menuItem2 = navLinks[1];
const menuItem3 = navLinks[2];
const menuItem4 = navLinks[3];
const menuItem5 = navLinks[4];
const menuItem6 = navLinks[5];
